...
> Copy this prompt verbatim when launching benchmark agents. Each agent should also be pointed at the full `com.github.copilot/agents/odin.agent.md` file and any skill files it references.

---

Read the file `com.github.copilot/agents/odin.agent.md` in full. Then read all skill files referenced by the agent spec — at minimum `skills/odin-review-prompts/SKILL.md`. Then answer these 5 questions:
